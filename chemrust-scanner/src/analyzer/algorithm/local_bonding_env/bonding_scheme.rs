...
pub(crate) const LOWER_FAC: f64 = 0.6;
pub(crate) const UPPER_FAC: f64 = 1.15;

pub(crate) fn ideal_bondlength(atomic_num_1: u8, atomic_num_2: u8) -> f64 {
...
pub(crate) fn is_bonded(
    distance: f64,
    ideal_bondlength: f64,
    lower_fac: f64,
    upper_fac: f64,
) -> bool {
